...
Function getTable7_17_R(qc As Double, isSand As Boolean) As Double
    Dim sp As New C_SP24_13330_2011
    getTable7_17_R = sp.Tables.t7_17_R (qc, isSand)
    Set sp = Nothing
End Function 

Function getTable7_17_fi(qc As Double, isSand As Boolean) As Double
    Dim sp As New C_SP24_13330_2011
    getTable7_17_fi = sp.Tables.t7_17_fi (qc, isSand)
    Set sp = Nothing
End Function 
