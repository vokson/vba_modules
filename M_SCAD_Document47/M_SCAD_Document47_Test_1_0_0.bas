...
Public Sub testGetGroups()
    ...
    Dim s As String : s = "jkgej (47/Name=" & Chr(34) & "Piles" & Chr(34) & " 2  : 6289 7531-7533/Name=" & _
        Chr(34) & "Axis 1" & Chr(34) & " 2  : 7538 r 7546 8 /Name=" & Chr(34) & _
         "Axis 2" & Chr(34) & " 2  : 7618 7729 /)j grr "
    ...
    If math.isArraysSame(dic.Items("Piles"), arr1) And _
       math.isArraysSame(dic.Items("Axis 1"), arr2) And _
       math.isArraysSame(dic.Items("Axis 2"), arr3) _
     Then
        Debug.Print "PASSED"
    Else
        Debug.Print "FAILED"
